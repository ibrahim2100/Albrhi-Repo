...
Instagram **4.1.10** · YouTube **1.20.0** · X **0.14.0** · Panel **0.9.21** · Watch **0.5.2** · TikTok **0.19.4** ·
Spotify **0.2.3** · YT Music **0.1.0** ·
NextUp **0.1.5** · suite **1.58.4**. **CarPlay is gone** — removed from this repository, to be
