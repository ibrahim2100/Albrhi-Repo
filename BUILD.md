...
Output:
```
packages/com.albrhi.tweak_3.0.0_iphoneos-arm64.deb
```
...
```bash
scp packages/com.albrhi.tweak_3.0.0_iphoneos-arm64.deb mobile@<device-ip>:/tmp/
ssh mobile@<device-ip>
sudo dpkg -i /tmp/com.albrhi.tweak_3.0.0_iphoneos-arm64.deb
