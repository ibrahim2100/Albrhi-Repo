...
static void SCIBuildTables(void) {
    _enTable = @{
        ...
        @"set_pivot_bar_note": @"Adds the Download Centre and History tabs and applies your saved tab order. Off while a launch fault is being investigated: this runs while YouTube is building its bar, before the app has drawn anything. Everything else in the tweak works without it, and the Download Centre is still in this settings screen.",
    ...
    _arTable = @{
        ...
        @"set_pivot_bar_note": @"يضيف تبويب مركز التحميلات وتبويب السجل، ويطبّق ترتيب التبويبات المحفوظ. مطفأ الآن ريثما يُفحص عطب في الإقلاع: هذا يُنفَّذ واليوتيوب يبني شريطه، قبل أن يرسم التطبيق شيئاً. كل ما عداه يعمل بدونه، ومركز التحميلات لا يزال داخل هذه الشاشة.",
