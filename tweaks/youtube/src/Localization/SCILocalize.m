...
static void SCIBuildTables(void) {
    _enTable = @{
        ...
        @"diag_native_button_none": @"No tap has reached this hook. Either the button was not tapped, or this build does not draw the class it lives on.",
        ...
        @"diag_native_button_ok": @"%lu tap(s) seen on this row, %lu of them the download button and answered by Albrhi.",
    ...
    _arTable = @{
        ...
        @"diag_native_button_none": @"لم تصل أي ضغطة إلى هذا الخطّاف. إمّا أن الزر لم يُضغط، أو أن هذه النسخة لا ترسم الصنف الذي يعيش فيه.",
        ...
        @"diag_native_button_ok": @"‏%lu ضغطة على هذا الصف، منها %lu على زر التحميل أجابها البرهان.",
