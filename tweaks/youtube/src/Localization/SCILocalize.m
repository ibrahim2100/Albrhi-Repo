...
static void SCIBuildTables(void) {
    _enTable = @{
        ...
        @"about_footer": @"Copyright (C) Ibrahim Ismail AL-Rahn. Released under the GNU General Public License v3. The source is at github.com/ibrahim2100/Albrhi-Repo.\n\nSegment data from SponsorBlock (sponsor.ajay.app), CC BY-NC-SA 4.0. The coloured markers on the progress bar are derived from iSponsorBlock by Galactic Dev, GPLv3.",
        @"section_ads": @"Ads",
    ...
    _arTable = @{
        ...
        @"about_footer": @"حقوق النشر (C) إبراهيم إسماعيل الرهن. تصدر برخصة جنو العمومية الإصدار الثالث. المصدر على github.com/ibrahim2100/Albrhi-Repo.\n\nبيانات المقاطع من سبونسر بلوك (sponsor.ajay.app) برخصة CC BY-NC-SA 4.0. العلامات الملوّنة على شريط التقدّم مشتقّة من iSponsorBlock لـ Galactic Dev برخصة GPLv3.",
