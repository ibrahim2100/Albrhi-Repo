...
static void SCIBuildTables(void) {
    _enTable = @{
        ...
        @"set_tab_history": @"History tab",
        @"set_tab_history_note": @"Adds a History tab to the bottom bar. YouTube opens it itself.",
        @"section_tab_bar_note": @"Choose which tabs the bottom bar carries, and in what order.",
    ...
    _arTable = @{
        ...
        @"set_tab_history": @"تبويب السجل",
        @"set_tab_history_note": @"يضيف تبويب السجل إلى الشريط السفلي، ويوتيوب هو من يفتحه.",
        @"section_tab_bar_note": @"اختر التبويبات التي يحملها الشريط السفلي وترتيبها.",
