...
static void SCIBuildTables(void) {
    _enTable = @{
        ...
        @"lic_enforce_footer": @"On. Without a valid licence the tweaks stand down — they install nothing and the apps behave as if Albrhi were not there. Turning this off is always possible from here; this page is never behind the gate.",
    ...
    _arTable = @{
        ...
        @"lic_enforce_footer": @"مفعّل. بلا ترخيص صالح تتوقّف الأدوات — لا تُركّب شيئاً وتتصرّف التطبيقات كأن البرهان غير موجود. وإطفاؤه ممكن دائماً من هنا؛ هذه الصفحة ليست خلف البوّابة أبداً.",
