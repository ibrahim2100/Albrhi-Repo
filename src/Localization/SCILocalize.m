...
+ (void)buildTables {
    _enTable = @{
        ...
        @"wn_u4_detail": @"Albrhi’s repo is now a full APT source with a control panel — upload several tweaks at once, from your phone.",
    ...
    _arTable = @{
        ...
        @"wn_u1_title": @"تنزيل 1080p على جهازك",
        @"wn_u1_detail": @"إنستقرام يحفظ أفضل نسخة بصيغة يرفضها iOS. الأداة تحوّلها على الجهاز نفسه — لا يُرفع شيء لأي خادم. فعّلها من التنزيلات.",
        @"wn_u2_title": @"التواريخ كما تريدها",
        @"wn_u2_detail": @"استبدل «2h» بتاريخ حقيقي، أو اعرض الاثنين. أنماط جاهزة، أو نمط تكتبه أنت، وحدّ زمني للوقت النسبي.",
        @"wn_u3_title": @"أسود حقيقي",
        @"wn_u3_detail": @"سمة OLED تحوّل رمادي إنستقرام الداكن إلى أسود نقي. أرحم للعين وللبطارية.",
        @"wn_u4_title": @"مستودع تديره بنفسك",
        @"wn_u4_detail": @"صار مستودع Albrhi سورس APT كاملًا بلوحة تحكم — ارفع عدة أدوات دفعة واحدة، من جوالك.",
