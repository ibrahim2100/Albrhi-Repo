...
+ (NSArray *)sections {
    return @[
        @{
            ...
            @"rows": @[
                [SCISetting menuCellWithTitle:SCILocalized(@"language_title") subtitle:SCILocalized(@"language_sub") menu:[self menus][@"albrhi_language"]]
            ]
        },
        @{
        ...
        @{
            ...
            @"rows": @[
                ...
                [SCISetting navigationCellWithTitle:SCILocalized(@"section_downloads")
                                           subtitle:@""
                                               icon:[SCISymbol symbolWithName:@"arrow.down.circle.fill"]
                                        navSections:@[@{
                                            @"header": @"",
                                            @"rows": @[
        ...
        @{
            ...
            @"rows": @[
                [SCISetting linkCellWithTitle:SCILocalized(@"developer_title") subtitle:@"Ibrahim" icon:[SCISymbol symbolWithName:@"person.crop.circle.fill" color:[SCIUtils SCIColor_Primary] size:20.0] url:@"https://github.com/SoCuul/SCInsta"],
                [SCISetting linkCellWithTitle:SCILocalized(@"credits_title") subtitle:SCILocalized(@"credits_sub") icon:[SCISymbol symbolWithName:@"heart.text.square.fill" color:[UIColor systemPinkColor] size:20.0] url:@"https://github.com/SoCuul/SCInsta"],
                [SCISetting linkCellWithTitle:SCILocalized(@"view_repo_title") subtitle:SCILocalized(@"view_repo_sub") icon:[SCISymbol symbolWithName:@"chevron.left.forwardslash.chevron.right" color:[SCIUtils SCIColor_Primary] size:20.0] url:@"https://github.com/SoCuul/SCInsta"]
            ],
            @"footer": [NSString stringWithFormat:@"Albrhi %@  ·  based on SCInsta (GPLv3)\n\nInstagram v%@", SCIVersionString, [SCIUtils IGVersionString]]
        }
    ];
}
